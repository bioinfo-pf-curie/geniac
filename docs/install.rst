...
| Default is ``py39_4.11.0``. See also options :ref:`install-ap_linux_distro` and :ref:`install-ap_docker_registry`.
...
| Default is ``almalinux:8.5``. See also options :ref:`install-ap_conda_release` and :ref:`install-ap_docker_registry`.
