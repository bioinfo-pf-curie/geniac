...
| Default is ``py312_25.1.1-2``. See also options :ref:`install-ap_linux_distro` and :ref:`install-ap_docker_registry`.
...
.. _install-ap_docker_registry_push_repo:

ap_docker_registry_push_repo
++++++++++++++++++++++++++++
| STRING
| Docker registry used to push the containers automatically generated by geniac.
| Default is empty string ''."

ap_docker_registry_push_user
++++++++++++++++++++++++++++
| STRING
| User used to Docker registry used to push the containers automatically generated by geniac.
| The user password should be set in your environment using the command ``nextflow secrets set DOCKER_REGISTRY_PUSH_USER your_password``
| Default is empty string ''."
...
.. _install-ap_install_docker_images:
...
.. _install-ap_install_podman_images:
...
.. _install-ap_install_singularity_images_from_registry:

ap_install_singularity_images_from_registry
+++++++++++++++++++++++++++++++++++++++++++

| BOOL
| Generate and install Singularity def files and images. The images are built using the containers avaibable on the registry defined by the variable :ref:`install-ap_docker_registry_push_repo`. This requires that geniac has been previously run using both :ref:`install-ap_install_docker_images` and :ref:`install-ap_push_images` options.
| Default is OFF.
...
| Default is ``almalinux:9.5``. See also options :ref:`install-ap_conda_release` and :ref:`install-ap_docker_registry`.
...
| BOOL
| Push images on the container registry defined in the variable :ref:`install-ap_docker_registry_push_repo`. Push will be effective whenever :ref:`install-ap_install_docker_images` or :ref:`install-ap_install_podman_images` are set to ON. 
| Default is OFF.
