...
| Default is ``26.1.1-3``. See also options :ref:`install-ap_linux_distro` and :ref:`install-ap_docker_registry`.
...
| Default is ``almalinux:9.7``. See also options :ref:`install-ap_conda_release` and :ref:`install-ap_docker_registry`.
