...
| BOOL
| Push images on the container registry defined in the variable :ref:`install-ap_docker_registry_pull_repo`. Push will be effective whenever :ref:`install-ap_install_docker_images` or :ref:`install-ap_install_podman_images` are set to ON. 
| Default is OFF.
