...
.. _install-ap_docker_push_registry:
...
| BOOL
| Push images on the container registry defined in the variable :ref:`install-ap_docker_push_registry`. Push will be effective whenever :ref:`install-ap_install_docker_images` or :ref:`install-ap_install_podman_images` are set to ON. 
| Default is OFF.
