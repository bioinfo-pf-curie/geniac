...
## module_dir = os.path.join(__location__, "../src/geniac")
## try:
...
try:
    from geniac import __version__ as version
except ImportError:
    version = ""
...
exclude_patterns = ["_build", "Thumbs.db", ".DS_Store", '*.inc.rst', ".venv"]
...
latex_documents = [
    (master_doc, "geniac.tex", "geniac Documentation", "Philippe Hupé", "manual")
]
