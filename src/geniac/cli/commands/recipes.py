...
class GeniacRecipes(GeniacInit):
    ...
    def cmake_recipes(self):
        ...
        shutil.copytree((self.working_dirs["build"]).as_posix() + "/workDir/results/docker/Dockerfiles/", output_dir)
        shutil.copytree((self.working_dirs["build"]).as_posix() + "/workDir/results/singularity/deffiles/", output_dir)
